...
test('does not add slashes to keys according to a comparator', function (t) {
  ...
  var slashedObj = slash(obj, {
    keyMatches: function (key) {
      return (key !== 'key1');
    }
  });
  
  t.deepEqual(slashedObj, {
    key1: '/value1',
    '/key2': '/value2'
  }, 'use comparator to handle if slash is added');
  
  t.end();
});

test('custom slashing method', function (t) {
